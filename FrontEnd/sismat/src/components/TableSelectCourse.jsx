...
const TableSelectCourse = () => {
  ...
  const [selectedYear, setSelectedYear] = useState(1); // Estado para el año seleccionado
            ...
            <tbody>
              {filteredCourses.map((course, index) => (
                <tr key={course.id} className="border-b border-[#800020]">
                  <td className="px-4 py-2 bg-[#8B0000] text-white">
                    {index + 1}
                  </td>
                  ...
                  <td className="px-4 py-2 text-center">
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCheckboxChange(course.id, course.credits)
                      }
                    />
                  </td>
                </tr>
