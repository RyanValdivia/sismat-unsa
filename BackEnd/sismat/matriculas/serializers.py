...
class InscriptionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Inscription
        fields = ['id', 'student_id', 'workload_id','status', 'course_status', 'nro_matricula']
...
class WorkloadSerializer(serializers.ModelSerializer):
    class Meta:
        model = Workload
        fields = ['id', 'group', 'capacity', 'year', 'semester', 'teacher_id', 'course_id']

class WorkloadLabSerializer(serializers.ModelSerializer):
    class Meta:
        model = WorkloadLab
        fields = ['id', 'group', 'capacity', 'year', 'semester', 'teacher_id', 'laboratory_id']
